...
export default function Signup() {
    ...
    <h2 className=" text-2xl font-bold teko text-center mb-8">Welcome to <span className="bg-slate-200 p-1 text-black rounded">Project manager</span></h2>
    ...
    <button className="bg-slate-600 w-full py-2 px-8 rounded mx-auto mt-12 text-white font-bold hover:bg-slate-200 hover:text-black transition-all flex justify-center items-center" onClick={submit} disabled={isLoading}>{isLoading?<Spinner></Spinner>:<div>Signup</div>}</button>
